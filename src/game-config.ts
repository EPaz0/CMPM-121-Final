...
export const FISH_VALUE_RANGE = 2; // The range of values a fish can gain each growth level (its max value gain is its minimum + this value)
export const REPRODUCTION_CHANCE = 0.2;
export const SUNLIGHT_CHANGE_CHANCE = 0.4;
export const FISH_MAX_FOOD = 3;
export const FISH_MATURE_GROWTH = 3; // The growth level at which a fish is considered mature
